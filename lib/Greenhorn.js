...
(function() {
  ...
  ***THE GREENHORN GAMING ENGINE***
  ...
  this.Greenhorn = (function() {
    ...
    Greenhorn.getBound = function(side) {
      switch (side) {
        case "top":
          return this.get("canvas", "height") / 2;
        case "bottom":
          return -this.get("canvas", "width") / 2;
        case "right":
          return this.get("canvas", "height") / 2;
        case "left":
          return -this.get("canvas", "width") / 2;
  ...
  this.Sprite = (function() {
    ...
    function Sprite(config) {
      ...
      this._checkBounds = __bind(this._checkBounds, this);
      ...
      setInterval(this._checkBounds, Math.ceil(1000 / env.FRAME_RATE));
      _list.push(this);
    ...
    Sprite.prototype._checkBounds = function() {
      var borders, bounds, hitBottom, hitLeft, hitRight, hitTop, offBottom, offLeft, offRight, offTop;
      bounds = {
      ...
      borders = {
        top: this._pos.y + this._dis.height / 2,
        bottom: this._pos.y - this._dis.height / 2,
        right: this._pos.x + this._dis.width / 2,
        left: this._pos.x - this._dis.width / 2
      };
