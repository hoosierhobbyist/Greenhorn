...
(function() {
  var AniCycle, AniSprite, AudioContext, EventEmitter, Greenhorn, KEYS, Line, Point, Sound, Sprite, TextSprite, Timer, env, _audioContext, _masterID, _masterUpdate, _mixin, _ref,
  ...
  Sprite = (function(_super) {
    ...
    function Sprite(config) {
      ...
      if (this._bnd == null) {
        this._bnd = [];
        this._bnd.push(new Point(-this._dis.width / 2, this._dis.height / 2, this._pos.x, this._pos.y));
        this._bnd.push(new Point(this._dis.width / 2, this._dis.height / 2, this._pos.x, this._pos.y));
        this._bnd.push(new Point(this._dis.width / 2, -this._dis.height / 2, this._pos.x, this._pos.y));
        this._bnd.push(new Point(-this._dis.width / 2, -this._dis.height / 2, this._pos.x, this._pos.y));
      }
    ...
    Sprite.prototype.get = function(what, _emit) {
      var pt, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
      if (_emit == null) {
        _emit = true;
      }
    ...
    Sprite.prototype.set = function(what, to, _emit) {
      ...
      if (what.match(/^x$/)) {
        ...
        this.set('y', to - _top.get('dist') * Math.sin(_top.get('a')));
      } else if (what.match(/^bottom$/)) {
        _bottom = this._bnd[0];
        _ref4 = this._bnd;
        ...
        this.set('y', to + _bottom.get('dist') * Math.sin(_bottom.get('a')));
      } else if (what.match(/^right$/)) {
        _right = this._bnd[0];
        _ref5 = this._bnd;
        ...
        this.set('x', to - _right.get('dist') * Math.cos(_right.get('a')));
      } else if (what.match(/^left$/)) {
        _left = this._bnd[0];
        _ref6 = this._bnd;
        ...
        this.set('x', to + _left.get('dist') * Math.cos(_left.get('a')));
    ...
    Sprite.prototype.collidesWith = function(other) {
      ...
      if (other === 'mouse') {
        ...
        if (this._dis.visible) {
          if ((this.get('left', false) < (_ref = Greenhorn.getMouseX()) && _ref < this.get('right', false)) && (this.get('bottom', false) < (_ref1 = Greenhorn.getMouseY()) && _ref1 < this.get('top', false))) {
            collision = true;
          }
        }
      } else {
        collision = true;
        if (this._dis.visible && other._dis.visible && this._dis.level === other._dis.level) {
          if (this.get('bottom', false) > other.get('top', false) || this.get('top', false) < other.get('bottom', false) || this.get('right', false) < other.get('left', false) || this.get('left', false) > other.get('right', false)) {
            collision = false;
          }
        } else {
          collision = false;
    ...
    Sprite.prototype.angleTo = function(other) {
      ...
      return Math.atan2(this._pos.y - otherY, this._pos.x - otherX) + Math.PI;
    };
