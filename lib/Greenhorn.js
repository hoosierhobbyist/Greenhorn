      ...
      switch (boundAction) {
        ...
        case 'SPRING':
          switch (side) {
            case 'top':
              return function() {
                return this.change('dy', env.SPRING_CONSTANT * (_bounds.top - this.get('top')), false);
              };
            case 'bottom':
              return function() {
                return this.change('dy', env.SPRING_CONSTANT * (_bounds.bottom - this.get('bottom')), false);
              };
            case 'right':
              return function() {
                return this.change('dx', env.SPRING_CONSTANT * (_bounds.right - this.get('right')), false);
              };
            case 'left':
              return function() {
                return this.change('dx', env.SPRING_CONSTANT * (_bounds.left - this.get('left')), false);
              };
          }
          break;
        case 'BOUNCE':
