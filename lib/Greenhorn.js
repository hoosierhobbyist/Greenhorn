...
(function() {
  var AniCycle, AudioContext, _audioContext, _masterID, _masterUpdate, _ref, _style,
  ...
  this.Greenhorn = (function() {
    ...
    _emnts.canvas.onmousemove = function(e) {
      this.mouseX = e.pageX;
      this.mouseY = e.pageY;
    };

    Greenhorn.getMouseX = function() {
      return _elmnts.canvas.mouseX - this.get('main', 'offsetLeft') - this.get('canvas', 'offsetLeft') - this.get('canvas', 'width') / 2;
    };

    Greenhorn.getMouseY = function() {
      return _elmnts.canvas.mouseY - this.get('main', 'offsetTop') - this.get('canvas', 'offsetTop') - this.get('canvas', 'height') / 2;
    };
    ...
    Greenhorn.start = function() {
      ...
      if (!(Greenhorn.isRunning() || (_elmnts.canvas.onclick != null))) {
        if (_firstTime) {
          ...
          if (_elmnts.main.parent === document.body) {
