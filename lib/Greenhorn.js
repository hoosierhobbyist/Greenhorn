  ...
  ***THE GREENHORN GAMING ENGINE***
  ...
  this.Greenhorn = (function() {
    ...
    Greenhorn.start = function() {
      var bottomPanelStyle, canvasStyle, correctHeight, correctWidth, mainStyle, panelHeaderStyle, panelStyle, titleStyle;
      ...
      Greenhorn.set("leftPanel", "style", panelStyle);
      Greenhorn.set("leftPanelHeader", "style", panelHeaderStyle);
      Greenhorn.set("canvas", "style", canvasStyle);
      Greenhorn.set("rightPanel", "style", panelStyle);
      Greenhorn.set("rightPanelHeader", "style", panelHeaderStyle);
