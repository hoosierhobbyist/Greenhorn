  ...
  ***THE GREENHORN GAMING ENGINE***
  ...
  this.Sprite = (function() {
    ...
    Sprite.prototype._start = function() {
      return this._updateID = setInterval(_update, 1000 / env.FRAME_RATE);
    };
  ...
  this.TextBox = (function(_super) {
      ...
      if (this._dis.visible) {
        ...
        if (this._text.length > 1) {
          ...
          for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
            line = _ref1[i];
            this._dis.context.fillText(line, xOffset - (this._dis.width / 2), yOffset - (this._dis.height / 2) + (this._font.size * i) + (i !== 0 ? this._font.spacing : 0));
          }
        } else {
    ...
    TextBox.prototype._update = function() {
      ...
      this._dis.width = 0;
      this._dis.height = (this._font.size * this._text.length) + (this._font.spacing * (this._text.length - 1));
      _ref1 = this._text;
      ...
      if (env.USE_AUDIO_TAG) {
        ...
        request.successCallback = (function(_this) {
          return function(buffer) {
            ...
            if (config.playOnLoad && Greenhorn.isRunning()) {
              return _this.play();
            }
          };
        })(this);
