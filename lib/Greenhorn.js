...
(function() {
  var AniCycle, AudioContext, key, makeSortRule, _audioContext, _i, _len, _masterID, _masterUpdate, _ref, _ref1, _style,
  ...
  ***THE GREENHORN GAMING ENGINE***
  ...
  this.Greenhorn = (function() {
    ...
    Greenhorn.start = function() {
      var correctHeight, correctWidth, _ctx, _ref1;
      if (_firstTime) {
        ...
        correctWidth = Greenhorn.get('canvas', 'offsetWidth');
        correctHeight = Greenhorn.get('canvas', 'offsetHeight');
        Greenhorn.set('canvas', 'width', correctWidth);
        Greenhorn.set('canvas', 'height', correctHeight);
        ...
        Greenhorn.set('bottomPanel', 'innerHTML', env.ENGINE.footer);
        ...
        _ctx.fillText(env.STARTUP.text, -_ctx.measureText(env.STARTUP.text).width / 2, env.STARTUP.size / 2);
        _ctx.restore();
  ...
  this.Sprite = (function() {
    ...
    Sprite.setAll = function() {
      var excep, sp, to, what, _j, _len1, _results;
    ...
    Sprite.changeAll = function() {
      var excep, sp, step, what, _j, _len1, _results;
  ...
  this.TextBox = (function(_super) {
    ...
    TextBox.prototype.set = function(what, to) {
      ...
      if (what === "text") {
        ...
        if ((this._font.size != null) && (this._font.name != null)) {
    ...
    TextBox.prototype.showBackground = function() {
      return this._background.visible = true;
    };

    TextBox.prototype.hideBackground = function() {
      return this._background.visible = false;
    };

    TextBox.prototype.showBorder = function() {
      return this._border.visible = true;
    };

    TextBox.prototype.hideBorder = function() {
      return this._border.visible = false;
    };

    TextBox.prototype._draw = function() {
      var i, line, xOffset, yOffset, _j, _len1, _ref1;
      if (this._dis.visible) {
        this._dis.context.save();
        this._dis.context.translate(this._pos.x, -this._pos.y);
        this._dis.context.rotate(-this._pos.a);
        ...
        yOffset = this._font.size / 4 * this._text.length;
        if (this._text.length > 2) {
          yOffset += this._font.size / 2 * (this._text.length - 2);
        }
        if (this.get('align').toLowerCase() === 'center') {
          xOffset = 0;
        } else if (this.get('align').toLowerCase() === 'left') {
          xOffset = -this._dis.width / 2 + this._margins.left;
          if (this._border.visible) {
            xOffset += this._border.size;
          }
        } else if (this.get('align').toLowerCase() === 'right') {
        ...
        if (this._text.length > 1) {
          ...
          this._dis.context.fillText(this._text[0], xOffset, yOffset);
        }
        return this._dis.context.restore();
      }
    };
  ...
  this.AniSprite = (function(_super) {
    ...
    AniSprite.prototype.set = function(what, to) {
      var cycle, i, _base, _base1, _base2, _j, _len1, _ref1;
      if (what === 'cellWidth' || what === 'cellHeight' || what === 'frameRate') {
        this._dis[what] = to;
      } else if (what === 'current' || what === 'animation' || what === 'cycle') {
        if (to !== this._dis.current.name) {
          this._dis.current.frame = 1;
          _ref1 = this._dis.cycles;
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            cycle = _ref1[_j];
            if (!(cycle.name === to)) {
              continue;
    ...
    AniSprite.prototype._draw = function() {
      if (this._dis.visible) {
        ...
        this._dis.context.translate(this._pos.x, -this._pos.y);
        this._dis.context.rotate(-this._pos.a);
        this._dis.context.drawImage(this._dis.image, (this._dis.current.frame - 1) * this._dis.cellWidth, (this._dis.current.index - 1) * this._dis.cellHeight, this._dis.cellWidth, this._dis.cellHeight, -this._dis.width / 2, -this._dis.height / 2, this._dis.width, this._dis.height);
        return this._dis.context.restore();
      }
    };
    ...
    AniSprite.prototype._update = function() {
      if (this._dis.visible) {
        if (this._dis.timer.getElapsedTime() >= (1000 / this._dis.frameRate)) {
          if (this._dis.current.frame < this._dis.current.stop) {
            this._dis.current.frame += 1;
          } else {
            this._dis.current.frame = this._dis.current.start;
          }
