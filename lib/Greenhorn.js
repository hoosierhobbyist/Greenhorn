  ...
  ***THE GREENHORN GAMING ENGINE***
  ...
  this.Greenhorn = (function() {
    ...
    Greenhorn.start = function() {
      var bottomPanelStyle, canvasStyle, correctHeight, correctWidth, leftPanelStyle, mainStyle, rightPanelStyle, titleStyle, _ref;
      ...
      this.set("title", "innerHTML", (_ref = env.ENGINE_TITLE) != null ? _ref : document.title);
