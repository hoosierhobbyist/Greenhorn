  ...
  Sprite = (function(_super) {
    ...
    Sprite.prototype.change = function(what, step, _emit) {
      ...
      if (what.match(/(^x$|^y$|^a$)/)) {
        ...
        this._dis.scale += step / env.FRAME_RATE;
        _ref2 = this._bnd;
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          pt = _ref2[_k];
          pt.set('dist', pt.get('dist') * this._dis.scale);
    ...
    Sprite.prototype.collidesWith = function(other) {
      var i, mousePos, myLine, myLines, otherLine, otherLines, p1, p2, pt, _i, _j, _k, _l, _len, _len1, _len10, _len11, _len12, _len13, _len14, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _s, _t, _u, _v, _w;
      if (other === 'mouse') {
    ...
    Sprite.prototype._draw = function() {
      ...
      if (this._dis.visible) {
        ...
        if (this._dis.highlight) {
          ...
          this._dis.context.moveTo(this._bnd[0].get('x'), -this._bnd[0].get('y'));
          _ref = this._bnd;
          for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
            pt = _ref[i];
            if (i !== 0) {
