...
(function() {
  var AniCycle, AudioContext, _audioContext, _masterID, _masterUpdate, _ref,
  ...
  document.onreadystatechange = function() {
    if (this.readyState === 'interactive') {
      return (typeof init !== "undefined" && init !== null ? init : Greenhorn.start)();
    }
  };
  ...
  this.Greenhorn = (function() {
    var key, _elmnts, _firstTime, _i, _isDown, _len, _startEverything;
    ...
    _elmnts.main.onkeydown = function(e) {
      e.preventDefault();
      return _isDown[e.keyCode] = true;
    };

    _elmnts.main.onkeyup = function(e) {
      e.preventDefault();
    ...
    Greenhorn.isDown = function(keyCode) {
    ...
    Greenhorn.addButton = function(config) {
      ...
      _ref = env.BUTTON_DEFAULT_CONFIG;
      for (key in _ref) {
    ...
    Greenhorn.start = function() {
      ...
      if (!(Greenhorn.isRunning() || (_elmnts.canvas.onclick != null))) {
        if (_firstTime) {
          ((_ref = document.querySelector('.gh')) != null ? _ref : document.body).appendChild(_elmnts.main);
    ...
    Sprite.prototype._update = function() {
      ...
      if (this._dis.visible) {
        ...
        switch (this._dis.boundAction) {
          ...
          case 'SPRING':
            if (hitTop) {
              this.change('ddy', -env.SPRING_CONSTANT);
            }
            if (hitBottom) {
              this.change('ddy', env.SPRING_CONSTANT);
            }
            if (hitRight) {
              this.change('ddx', -env.SPRING_CONSTANT);
            }
            if (hitLeft) {
              this.change('ddx', env.SPRING_CONSTANT);
            }
  ...
  this.AniSprite = (function(_super) {
    ...
    AniSprite.prototype.set = function(what, to) {
      var cycle, i, _base, _i, _len, _ref;
      if (what.match(/(^current$|^animation$|^cycle$)/i)) {
