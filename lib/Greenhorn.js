...
(function() {
  var AniCycle, AudioContext, key, makeSortRule, _audioContext, _i, _len, _masterID, _masterUpdate, _ref, _ref1,
  ...
  ***THE GREENHORN GAMING ENGINE***
  ...
  document.onreadystatechange = function() {
    if (this.readyState === 'interactive') {
      return (typeof init !== "undefined" && init !== null ? init : Greenhorn.start).call();
    }
  };

  document.onkeydown = function(e) {
    e.preventDefault();
    return isDown[e.keyCode] = true;
  };

  document.onkeyup = function(e) {
    e.preventDefault();
    return isDown[e.keyCode] = false;
  };
  ...
  this.Greenhorn = (function() {
    ...
    Greenhorn.addButton = function(config) {
      var button, value, _base, _ref1, _ref2;
      if (config == null) {
        config = {};
      }
      _buttonID += 1;
      ...
      return _elmnts[config.elmnt].appendChild(button);
    };
    ...
    Greenhorn.start = function() {
      ...
      Greenhorn.set("main", "style", mainStyle);
      Greenhorn.set("title", "style", titleStyle);
      Greenhorn.set("leftPanel", "style", leftPanelStyle);
      Greenhorn.set("canvas", "style", canvasStyle);
      Greenhorn.set("rightPanel", "style", rightPanelStyle);
      Greenhorn.set("bottomPanel", "style", bottomPanelStyle);
      ...
      _elmnts.canvas.getContext("2d").translate(Greenhorn.get("canvas", "width") / 2, Greenhorn.get("canvas", "height") / 2);
      Greenhorn.set("title", "innerHTML", document.title);
      Greenhorn.set("leftPanel", "innerHTML", env.ENGINE_LEFT_PANEL);
      Greenhorn.set("rightPanel", "innerHTML", env.ENGINE_RIGHT_PANEL);
      Greenhorn.set("bottomPanel", "innerHTML", env.ENGINE_BOTTOM_PANEL);
  ...
  if ((this.AudioContext != null) || (this.webkitAudioContext != null)) {
    AudioContext = (_ref1 = this.AudioContext) != null ? _ref1 : this.webkitAudioContext;
  ...
  this.Sound = (function() {
    function Sound(config) {
      var mp3_src, ogg_src, request, value, wav_src, _ref2;
      if (config == null) {
        config = {};
      }
    ...
    Sound.prototype.play = function(opt) {
      ...
      if (env.USE_AUDIO_TAG) {
        this._audio.loop = (_ref2 = opt.loop) != null ? _ref2 : false;
        this._audio.volume = (_ref3 = opt.volume) != null ? _ref3 : 1.0;
        return this._audio.play();
      } else {
        if (this._isEnded) {
          gainNode = _audioContext.createGain();
          gainNode.gain.value = (_ref4 = opt.volume) != null ? _ref4 : 1.0;
          this._isEnded = false;
          ...
          this._source.loop = (_ref5 = opt.loop) != null ? _ref5 : false;
