...
(function() {
  ...
  EventEmitter = (function() {
    ...
    EventEmitter.prototype.once = function(event, listener, options) {
      ...
      wrapper = function() {
        ...
        index = this._events[event].indexOf(wrapper);
        return this._expired.push(index);
      };
    ...
    EventEmitter.prototype.emit = function() {
      var args, event, i, index, j, listener, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2;
      ...
      if (this._events[event] != null) {
        ...
        if (this._expired.length) {
          _ref1 = this._expired;
          for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
            index = _ref1[i];
            this._events[event].splice(index, 1);
            for (j = _k = i, _ref2 = this._expired.length; i <= _ref2 ? _k < _ref2 : _k > _ref2; j = i <= _ref2 ? ++_k : --_k) {
              this._expired[j] -= 1;
            }
          }
          this._expired = [];
    ...
    EventEmitter.prototype.remove = function(event, listener) {
      var i, index, wrapper, _i, _len, _ref;
      if (this._events[event] != null) {
        if (listener != null) {
          ...
          if (i > -1) {
            ...
            for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
              wrapper = _ref[index];
              if (wrapper['gh-original'] === listener) {
                this._events[event].splice(index, 1);
                if (this._events[event].length === 0) {
                  delete this._events[event];
                }
  ...
  Sprite = (function(_super) {
    ...
    Sprite.prototype._start = function() {
      this.emit('start');
      return this._updateID = setInterval(((function(_this) {
        return function() {
          return _this._update;
        };
      })(this)), 1000 / Greenhorn.config.frameRate);
    };
  ...
  Sound = (function() {
    var AudioContext, audioContext, _list, _play, _ref;

    _list = [];

    _play = function(opt) {
      var gainNode, _ref, _ref1;
      gainNode = audioContext.createGain();
      this._source = audioContext.createBufferSource();
      this._source.buffer = this._buffer;
      this._source.loop = (_ref = opt.loop) != null ? _ref : this._config.loop;
      ...
      gainNode.gain.value = (_ref1 = opt.volume) != null ? _ref1 : this._config.volume;
    ...
    function Sound(_config) {
      ...
      if (!/(^\w+:\/\/|^\/)/.test(this._config.url)) {
        if (/\/$/.test(Sound.config.path)) {
          this._config.url = Sound.config.path + this._config.url;
      ...
      if (Sound.config.useAudioTag) {
        ...
        request.errorCallback = function() {
          return console.log("could not load sound file at url: " + this._config.url);
        };
