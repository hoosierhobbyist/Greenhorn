  ...
  ***THE GREENHORN GAMING ENGINE***
  ...
  this.Sound = (function() {
    ...
    Sound.prototype.play = function(opt) {
      ...
      this._source.loop = (_ref1 = opt.loop) != null ? _ref1 : false;
      this._source.connect(_audioContext.destination);
      return this._source.start(0);
    };

    Sound.prototype.stop = function() {
      return this._source.stop(0);
    };
