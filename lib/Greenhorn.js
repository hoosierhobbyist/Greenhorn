...
(function() {
  ...
  Greenhorn = (function(_super) {
    var key, _context, _currentState, _firstTime, _footer, _i, _isDown, _leftPanel, _leftPanelHeader, _len, _main, _masterID, _masterUpdate, _rightPanel, _rightPanelHeader, _start, _title;

    __extends(Greenhorn, _super);
    ...
    function Greenhorn() {
      Greenhorn.__super__.constructor.call(this);
    }
    ...
    Greenhorn.canvas = document.createElement('canvas');
    ...
    _context = Greenhorn.canvas.getContext('2d');
    ...
    _main.appendChild(Greenhorn.canvas);
    ...
    _start = function() {
      _masterID = setInterval(_masterUpdate, 1000 / this.config.frameRate);
      Sprite._startAll();
      Sound._playAll();
    };
    ...
    Greenhorn.start = function(stateName) {
      ...
      if (!Greenhorn.isRunning()) {
        if (_firstTime) {
          ...
          _title.innerHTML = Greenhorn.config.title;
          _leftPanelHeader.innerHTML = Greenhorn.config.leftHeader;
          _rightPanelHeader.innerHTML = Greenhorn.config.rightHeader;
          _footer.innerHTML = Greenhorn.config.footer;
          Greenhorn.canvas.innerHTML = 'Your browser does not support the &ltcanvas&gt tag';
          Greenhorn.canvas.width = Greenhorn.canvas.clientWidth;
          Greenhorn.canvas.height = Greenhorn.canvas.clientHeight;
          _context.translate(Greenhorn.canvas.width / 2, Greenhorn.canvas.height / 2);
          _context.save();
          _context.globalAlpha = 1.0;
          _context.textAlign = 'center';
          _context.textBaseline = 'middle';
          _context.font = "" + Greenhorn.config.startUp.size + "px " + Greenhorn.config.startUp.font;
          _context.fillStyle = Greenhorn.config.startUp.color;
          _context.fillText(Greenhorn.config.startUp.text, 0, 0);
          _context.restore();
          Greenhorn.canvas.onclick = function() {
            _start();
            Greenhorn.changeState(stateName != null ? stateName : 'GREENHORN');
            return this.canvas.onclick = function(e) {
