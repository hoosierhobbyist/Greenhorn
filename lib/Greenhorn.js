...
(function() {
  ...
  Point = (function() {
    ...
    Point.prototype.change = function(what, step) {
      ...
      if (what === 'x') {
        ...
        _x = this.get('dist') * Math.cos(step);
        _y = this.get('dist') * Math.sin(step);
        this.change('x', _x);
        this.change('y', _y);
      } else if (what === 'dist') {
  ...
  Sprite = (function(_super) {
    ...
    function Sprite(config) {
      var angles, key, magnitudes, value, _a, _dist, _ref;
      if (config == null) {
        config = {};
      }
      ...
      if (config.bounds == null) {
        ...
        _dist = Math.sqrt(Math.pow(config.height / 2, 2) + Math.pow(config.width / 2, 2));
        config.bounds = [
          {
    ...
    Sprite.prototype.set = function(what, to, _emit) {
      var k, newCollision, oldCollision, proxy, pt, side, v, _bottom, _i, _j, _k, _l, _left, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _right, _top;
      if (_emit == null) {
        _emit = true;
      }
      if (what.match(/(^x$|^y$|^a$)/)) {
        ...
        this._bnd = [];
        for (_m = 0, _len4 = to.length; _m < _len4; _m++) {
          pt = to[_m];
          this._bnd.push(new Point(pt.x, pt.y, this));
        }
      } else {
    ...
    Sprite.prototype._draw = function() {
      ...
      if (this._dis.visible) {
        ...
        if (this._dis.highlight) {
          ...
          this._dis.context.moveTo(this._bnd[0]._x, -this._bnd[0]._y);
          _ref = this._bnd;
          for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
            pt = _ref[i];
            if (i !== 0) {
              this._dis.context.lineTo(pt._x, -pt._y);
            }
          }
